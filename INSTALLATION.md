...
- [Chrome and Chromium package](https://github.com/loganpendragonmultiverse/tabitha-workspaces/releases/download/v1.1.0/tabitha-workspaces-1.1.0-chrome.zip)
- [Firefox package](https://github.com/loganpendragonmultiverse/tabitha-workspaces/releases/download/v1.1.0/tabitha-workspaces-1.1.0-firefox.zip)

## Chromium browsers

1. Download and extract the `tabitha-workspaces-1.1.0-chrome.zip` release asset.
...
1. Extract `tabitha-workspaces-1.1.0-firefox.zip`.
